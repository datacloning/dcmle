...
setGeneric("cumuplot", function(x, ...)
    standardGeneric("cumuplot"))
setMethod("cumuplot", "MCMClist", function(x, ...)
    coda::cumuplot(x, ...))
setMethod("cumuplot", "codaMCMC", function(x, ...)
    cumuplot(as(x, "MCMClist"), ...))
setMethod("cumuplot", "dcmle", function(x, ...)
    cumuplot(as(x, "MCMClist"), ...))
